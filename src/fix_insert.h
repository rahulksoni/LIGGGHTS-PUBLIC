...
class FixInsert : public Fix {
 ...
 protected:
	  ...
	  /******************************************************************************/
//	  void resize(int increment, int size, double *array);
//	  virtual void resize(int increment, int size, double *array);
//	  int calc_daughter_distribution();
//	  virtual int calc_daughter_distribution();
	  /******************************************************************************/
