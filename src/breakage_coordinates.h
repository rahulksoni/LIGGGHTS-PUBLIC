...
void fill_bounds(int mill_axis, double x_min, double x_max, double y_min, double y_max, double z_min, double z_max)
	{				
...
double random_coordinates_generator(int dimension)	//dimension defines whether it is to be done for x or y or z. 0 for x, 1 for y and 2 for z
	{
